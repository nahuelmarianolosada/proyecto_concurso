...
public class Postulante  implements java.io.Serializable {
    ...
    public String toString() {
        return "Postulante "+ idPostulante + "{cargo=" + cargo.getIdCargo() + ", persona=(" + persona.getDni() + ", " + persona.getApellido() + ", fojas=" + fojas + ", antecedentes=" + antecedentes + ", oposicion=" + oposicion + ", puntaje=" + puntaje + '}';
    }
