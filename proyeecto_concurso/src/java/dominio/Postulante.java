...
public class Postulante implements java.io.Serializable {
    ...
    public Postulante(int idInscripcion, Cargo cargo, Persona persona) {
    ...
    public Postulante(int idInscripcion, Cargo cargo, Persona persona, Integer fojas, Double antecedentes, Double oposicion, Double puntaje) {
        this.idInscripcion = idInscripcion;
        this.cargo = cargo;
        this.persona = persona;
        this.fojas = fojas;
    ...
    public Cargo getCargo() {
        if (cargo != null) {
            ...
            return new Cargo(0, "No especificado", "No especificado", 0, "No especificado", "No especificado", "No especificado", "No especificado");
        }
