...
public class Resolucion implements java.io.Serializable {
    ...
    /**
     *
     * Método que setea a 5 caracteres el numero del expediente
     *
     * @param numero numero que se desea setear
     * @return el numero con 5 caracteres formateado
     */
    public String formatearNumero(String numero) {
        String numeroResolucionFormateado = numero;
        char[] cadenaCaracteres = numero.toCharArray();
        if (cadenaCaracteres.length != 5) {
            ...
            numeroResolucionFormateado = new String(numeroFormateado);
        }
        return numeroResolucionFormateado;
    }
